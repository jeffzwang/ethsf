...
const BookedStay = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center p-4 bg-green-100 rounded-lg shadow-[0px_3px_6px_rgba(146,151,160,0.52)] m-6 w-[600px]">
        {transactionStatus !== 'Confirmed' ? (<div role="status">
